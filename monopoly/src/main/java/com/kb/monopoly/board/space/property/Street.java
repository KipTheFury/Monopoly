...
public class Street extends Property
{
     ...
     */
    public Street(final String name, final int value, final PropertySets.SetColour setColour, final int buildingCost, final int[] rent)
    {
        super(name, value);
